...
public final class ScanConfigProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "8google/cloud/websecurityscanner/v1beta/scan_config.proto\022&google.cloud.websecu"
          ...
          + "can_run.proto\032\037google/protobuf/timestamp.proto\"\246\r\n\n"
          + "ScanConfig\022\014\n"
          + "\004name\030\001 \001(\t\022\031\n"
          + "\014display_name\030\002 \001(\tB\003\340A\002\022\017\n"
          + "\007max_qps\030\003 \001(\005\022\032\n\r"
          + "starting_urls\030\004 \003(\tB\003\340A\002\022Y\n"
          + "\016authentication\030\005 \001(\0132A.google.cloud.websecuritysc"
          + "anner.v1beta.ScanConfig.Authentication\022P\n\n"
          + "user_agent\030\006 \001(\0162<.google.cloud.websec"
          + "urityscanner.v1beta.ScanConfig.UserAgent\022\032\n"
          + "\022blacklist_patterns\030\007 \003(\t\022M\n"
          + "\010schedule\030\010"
          + " \001(\0132;.google.cloud.websecurityscanner.v1beta.ScanConfig.Schedule\022[\n"
          + "\020target_platforms\030\t \003(\0162A.google.cloud.websecurity"
          + "scanner.v1beta.ScanConfig.TargetPlatform\022{\n"
          + "!export_to_security_command_center\030\n"
          + " \001(\0162P.google.cloud.websecurityscanner.v1"
          + "beta.ScanConfig.ExportToSecurityCommandCenter\022C\n\n"
          + "latest_run\030\013 \001(\0132/.google.cloud.websecurityscanner.v1beta.ScanRun\022P\n\n"
          + "risk_level\030\014"
          + " \001(\0162<.google.cloud.websecurityscanner.v1beta.ScanConfig.RiskLevel\032\224\003\n"
          + "\016Authentication\022i\n"
          + "\016google_account\030\001 \001(\0132O.google.cloud.websecurityscanner.v1beta"
          + ".ScanConfig.Authentication.GoogleAccountH\000\022i\n"
          + "\016custom_account\030\002 \001(\0132O.google.clou"
          + "d.websecurityscanner.v1beta.ScanConfig.Authentication.CustomAccountH\000\032@\n\r"
          + "GoogleAccount\022\025\n"
          + "\010username\030\001 \001(\tB\003\340A\002\022\030\n"
          + "\010password\030\002 \001(\tB\006\340A\002\340A\004\032X\n\r"
          + "CustomAccount\022\025\n"
          + "\010username\030\001 \001(\tB\003\340A\002\022\030\n"
          + "\010password\030\002 \001(\tB\006\340A\002\340A\004\022\026\n"
          + "\tlogin_url\030\003 \001(\tB\003\340A\002B\020\n"
          + "\016authentication\032b\n"
          + "\010Schedule\0221\n\r"
          + "schedule_time\030\001 \001(\0132\032.google.protobuf.Timestamp\022#\n"
          + "\026interval_duration_days\030\002 \001(\005B\003\340A\002\"`\n"
          + "\tUserAgent\022\032\n"
          + "\026USER_AGENT_UNSPECIFIED\020\000\022\020\n"
          + "\014CHROME_LINUX\020\001\022\022\n"
          + "\016CHROME_ANDROID\020\002\022\021\n\r"
          + "SAFARI_IPHONE\020\003\"N\n"
          + "\016TargetPlatform\022\037\n"
          + "\033TARGET_PLATFORM_UNSPECIFIED\020\000\022\016\n\n"
          ...
          + "\003LOW\020\002\"m\n"
          + "\035ExportToSecurityCommandCenter\0221\n"
          + "-EXPORT_TO_SECURITY_COMMAND_CENTER_UNSPECIFIED\020\000\022\013\n"
          + "\007ENABLED\020\001\022\014\n"
          + "\010DISABLED\020\002:_\352A\\\n"
          + ",websecurityscanner."
          + "googleapis.com/ScanConfig\022,projects/{project}/scanConfigs/{scan_config}B\227\002\n"
          + "*com.google.cloud.websecurityscanner.v1betaB\017"
          + "ScanConfigProtoP\001ZXgoogle.golang.org/genproto/googleapis/cloud/websecurityscanne"
          ...
          + "Cloud::WebSecurityScanner::V1betab\006proto3"
    };
    descriptor =
